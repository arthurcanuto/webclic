...
// Regra de validação para valor mínimo e máximo em decimal/moeda
...
// fim - Regra de validação para valor mínimo e máximo em decimal/moeda
...
$.validator.addMethod( "dateBRAtual", function(value, element) {

	// Inicializamos o objeto Date() com data e horário atual
	var date1 = new Date();

	var date2 = value;
	var dia2 = date2.substr(0,2);
	var mes2 = date2.substr(3,2);
	var ano2 = date2.substr(6,4);
	var date2 = ano2+'-'+mes2+'-'+dia2;

	// Inicializamos uma data no passado
	date2 = new Date(date2+' 23:59:59');

	// Verificamos se primeira data é maior ou menor que a segunda
...
}, "Informe uma data maior ou igual a atual." );
